...
public class SerializationImpl : SerializationAPI.Serialization
{
    public override object Deserialize(string serial)
    {
    ...
    private static object LoadDeckV1(XElement xml)
    {
        var deck = new Deck();
    ...
    private static object LoadDeckV2(XElement xml)
    {
        var deck = new Deck();
